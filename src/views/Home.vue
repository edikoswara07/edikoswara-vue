...
import Blog from "../parts/Blog.vue";
...
export default {
	...
	data() {
		return {
			datas: {
				title: "Tentang Edi Koswara",
				image:
					"https://images.unsplash.com/photo-1540126034813-121bf29033d2?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=752&q=80",
				description:
